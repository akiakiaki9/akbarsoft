    ...
    const PRICING = [
        {
            ...
            subtitle: "Landing page - a one-page site to attract customers, advertise, and generate leads.",
            price: '$300 - $500',
            discount: '$200 - $300',
            includes: {
        ...
        },
        {
            ...
            subtitle: "A fully functional business website with scalability and expandable features.",
            price: '$400 - $1500',
            discount: '$350 - $1000',
            includes: {
                include_1: "Responsive Design",
                include_2: "Website Builder",
                include_3: "Social Media Integration",
                include_4: "Basic SEO",
                include_5: "Contact Form Integration"
            }
        },
        {
            id: 3,
            title: "Map Listings",
            subtitle: "Add your company to Google Maps, 2GIS, Yandex.Maps (Taxi), and Apple Maps",
            price: '$100',
            discount: '$50',
            includes: {
                include_1: "Google Maps Listing",
                include_2: "2GIS Listing",
                include_3: "Yandex.Maps Listing",
                include_4: "Apple Maps Listing",
                include_5: "Support for all formats"
            }
        },
    ];
            ...
            {isModalOpen && selectedPlan && (
                <div className="join-modal-overlay">
                    <div className="join-modal-content">
                        ...
                        <p>Write what exactly you want to order and we will definitely contact you!</p>
