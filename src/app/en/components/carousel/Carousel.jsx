...
const testimonials = [
    {
        ...
        title: "Артем Ефремов",
        subtitle: "Акбар, профессионал своего дела, быстро закрыл вопрос с сайтом. Дедлайн был 3 дня, Акбар выполнил работу в срок и порадовал нашу команду качественными анимациями и приятным контентом, сайт вышел качественный. Вопросов нет, Akbar Soft это - цена-качество.",
